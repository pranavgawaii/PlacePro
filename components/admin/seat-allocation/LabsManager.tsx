  ...
  return (
    <section className="rounded-lg card-border bg-white p-5 space-y-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-lg font-semibold text-neutral-900">Labs</h3>
          <p className="text-sm text-neutral-600">Configure exam labs and seat capacity for allocation runs.</p>
        </div>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="space-y-1.5 md:col-span-2">
          <Label htmlFor="seat-lab-name">Lab name</Label>
          <Input
            id="seat-lab-name"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="seat-lab-total">Total seats</Label>
          <Input
            id="seat-lab-total"
            type="number"
            min={1}
        ...
        <div className="space-y-1.5">
          <Label htmlFor="seat-lab-rows">Rows (optional)</Label>
          <Input
            id="seat-lab-rows"
            type="number"
            min={1}
        ...
        <div className="space-y-1.5">
          <Label htmlFor="seat-lab-columns">Columns (optional)</Label>
          <Input
            id="seat-lab-columns"
            type="number"
            min={1}
        ...
        <table className="w-full text-sm">
          <thead className="bg-neutral-50 text-neutral-600">
            <tr>
              ...
              <th className="px-3 py-2 text-left font-semibold">Layout</th>
          ...
          <tbody className="divide-y divide-neutral-200 bg-white">
            {labs.length === 0 ? (
              ...
              labs.map((lab) => (
                <tr key={lab.id}>
                  <td className="px-3 py-2.5 font-medium text-neutral-900">{lab.lab_name}</td>
                  <td className="px-3 py-2.5 text-neutral-700">{lab.total_seats}</td>
