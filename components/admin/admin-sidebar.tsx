...
import { LayoutDashboard, Users, Building, Megaphone, LifeBuoy, Settings, Armchair, ClipboardCheck } from "lucide-react";
...
export function AdminSidebar() {
    ...
    const links = [
        ...
        { href: "/admin/coordinator", label: "Coordinator", icon: ClipboardCheck },
