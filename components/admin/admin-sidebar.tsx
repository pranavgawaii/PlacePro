...
import { LayoutDashboard, Users, Building, Megaphone, LifeBuoy, Settings, Armchair, UserCog } from "lucide-react";
...
export function AdminSidebar() {
    ...
    const links = [
        ...
        { href: "/admin/coordinator", label: "Coordinator", icon: UserCog },
