...
export function LandingHero() {
    return (
        <div className="flex flex-col items-center pt-6 sm:pt-8 pb-4 relative z-10 px-0 sm:px-4">
            <motion.div
            ...
            <motion.h1
                ...
                className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center leading-[1.1] mb-4 max-w-4xl tracking-tight text-black"
            >
            ...
            <motion.p
                ...
                className="text-center text-gray-600 max-w-xl text-xs sm:text-sm leading-relaxed mb-4 font-light px-4"
            >
            ...
            <motion.div
                ...
                className="flex flex-col sm:flex-row items-center gap-3 mb-0 relative scale-90 md:scale-95 lg:scale-100"
            >
                <Link href="/signup">
                    <button className="bg-black text-white px-6 py-2.5 text-xs font-medium relative hover:bg-blue-600 transition-colors w-full sm:w-auto">
                ...
                <button className="bg-[#E5E5E5] text-black px-6 py-2.5 text-xs font-medium hover:bg-[#d4d4d4] transition-colors relative w-full sm:w-auto">
