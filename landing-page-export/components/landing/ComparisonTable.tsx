                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-black text-white">
                                ...
                                <th className="py-6 px-6 w-1/3 bg-blue-600">
                        ...
                        <tbody className="text-sm font-medium">
                            {comparisonData.map((row, i) => (
                                <tr key={i} className="border-b border-black last:border-0 hover:bg-neutral-50 transition-colors">
                                    <td className="py-5 px-6 border-r border-black font-bold text-black">{row.f}</td>
                                    ...
                                    <td className="py-5 px-6 text-gray-500 font-normal">{row.l}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
